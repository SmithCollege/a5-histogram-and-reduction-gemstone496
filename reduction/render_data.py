...
diverge = pd.read_csv(PATH + "diverge.csv", header=0, index_col=0)
converge = pd.read_csv(PATH + "nonDiverge.csv", header=0, index_col=0)
...
times = pd.wide_to_long(times, ['cpu', 'diverge', 'converge'], i='run', j='size')
